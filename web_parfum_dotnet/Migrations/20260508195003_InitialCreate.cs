        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopNotes = table.Column<string>(type: "text", nullable: true),
                    MiddleNotes = table.Column<string>(type: "text", nullable: true),
                    BaseNotes = table.Column<string>(type: "text", nullable: true),
                    Accord1 = table.Column<string>(type: "text", nullable: true),
                    Accord2 = table.Column<string>(type: "text", nullable: true),
                    Accord3 = table.Column<string>(type: "text", nullable: true),
                    Accord4 = table.Column<string>(type: "text", nullable: true),
                    Accord5 = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BottleLevel = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Collections_Perfumes_PerfumeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sprays = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyLogs_Perfumes_PerfumeId",
                        column: x => x.PerfumeId,
                        principalTable: "Perfumes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Likes_Perfumes_PerfumeId",
                        column: x => x.PerfumeId,
                        principalTable: "Perfumes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommunityPosts_Perfumes_PerfumeId",
                        column: x => x.PerfumeId,
                        principalTable: "Perfumes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityPosts_PerfumeId",
                table: "CommunityPosts",
                column: "PerfumeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_PerfumeId",
                table: "Likes",
                column: "PerfumeId");

            migrationBuilder.CreateIndex(
                name: "IX_Likes_UserId_PerfumeId",
                table: "Likes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_UserId_PerfumeId",
                table: "Reviews",
                columns: new[] { "UserId", "PerfumeId" },
                unique: true);
